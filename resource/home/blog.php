<style>
    ...
    padding: 10px; /* Khoảng cách giữa nền và chữ */
...
.offcanvas-menu-overlay {
  background-color: rgba(0, 0, 0, 0.5); /* Màu nền overlay */
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
.offcanvas-menu-wrapper {
  ...
  height: 100%;
  width: 280px;
  background-color: #333; /* Màu nền của offcanvas menu */
  padding: 20px;
  z-index: 10000;
  display: none;
  overflow-y: auto;
...
.offcanvas__top__hover span {
  color: #fff; /* Màu chữ của phần Usd */
}
...
.offcanvas__top__hover li {
  color: #fff; /* Màu chữ của các mục trong dropdown */
  cursor: pointer;
  font-size: 16px;
}
...
.header__top p, .header__text p {
  color: #fff; /* Màu chữ của các đoạn văn bản trong header */
}

.header__menu ul li a {
  color: #fff; /* Màu chữ của các liên kết trong menu */
  font-size: 16px;
}

.header__menu ul li a:hover {
  color: #ffcc00; /* Màu chữ khi hover vào liên kết trong menu */
}
...
.blog__item__text {
  background-color: #fff; /* Màu nền của phần text trong mỗi blog item */
  padding: 20px;
  text-align: center;
}

.blog__item__text span, .blog__item__text h5, .blog__item__text a {
  color: #000; /* Màu chữ của các phần text trong mỗi blog item */
}
...
.blog__item__text a {
  ...
  font-weight: bold;
  text-decoration: none;
  color: #333; /* Màu chữ của liên kết trong mỗi blog item */
}

.blog__item__text a:hover {
  color: #ffcc00; /* Màu chữ khi hover vào liên kết trong mỗi blog item */
}
