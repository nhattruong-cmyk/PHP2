                    ...
                    <div id="form-add-chuyenbay" class="row flex-column  g-3">
                        ...
                        <div class="col-6">
                            ...
                            <select id="MaSanBayXuatPhat-org" name="MaSanBayXuatPhat" class="select2 form-select"
                                ...
                                foreach ($list_sanbay as $item) {
                                    extract($item);
                                    ?>
                                    <option value="<?= $MaSanBay ?>" <?= (!empty($MaSanBayXuatPhat) && $MaSanBayXuatPhat == $MaSanBay) ? 'selected' : '' ?>>
                                        <?= $MaSanBay ?>
                                    </option>
                                    <?php
                                }
                        ...
                        <div class="col-6">
                            ...
                            <select id="MaSanBay-org" name="MaSanBay" class="select2 form-select"
                                ...
                                foreach ($list_sanbay as $item) {
                                    extract($item); ?>
                                    <option value="<?= $MaSanBay ?>" <?= (!empty($MaSanBayDen) && $MaSanBayDen == $MaSanBay) ? 'selected' : '' ?>>
                                        <?= $MaSanBay ?>
                                    </option>
                                    <?php
                                }
                        ...
                        <div class="col-6">
                            ...
                            <input type="datetime-local"
                                ...
                                id=""
                                value="<?= !empty($_POST['NgayGioXuatPhat']) ? $_POST['NgayGioXuatPhat'] : $NgayGioXuatPhat ?>"
                        ...
                        <div class="col-6">
                            ...
                            <input type="datetime-local"
                                ...
                                id="" value="<?= !empty($_POST['NgayGioDen']) ? $_POST['NgayGioDen'] : $NgayGioDen ?>"
                                name="NgayGioDen">
                            <span id="red_error" class="form-text">
